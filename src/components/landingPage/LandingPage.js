            ...
            <div class="container">
              <div class="row">
                <div class="col-md-8">
                  ...
                  <p>
                    We are a bunch of young professionals who bring together
                    vast experience from the domains of brand management,
                    advertising, public relations, event management, media
                    planning, social media management, and more! We build upon
                    inspirational ideas and deliver compelling brand messages to
                    engage your target audience across platforms and mediums.
                  </p>
                  <p>
                    <b>
                      10 + Years of Experience, 4 Successful Talk Shows, 100 +
                      Events, 5000 + Happy Clients
                    </b>
                  </p>
                  <p>
                    Brands Impact aims to bridge a need gap in brand consulting
                    services with a 360 degree approach from drawing up a
                    strategy to its execution, we do it all for the clients we
                    work with. Having successfully executed 100 Events, such as,{" "}
                    <a
